...
* In most projects, we often give you only one main file to test with. For example,
 this main file is a test for a postitive_or_negative() function similar to the one
...
arrie@ubuntu:/debugging$ cat 1-main.c
#include <stdio.h>
...
_ Your output should look like this:
...
_ Output looks good for 04/01/1997! Let’s make a new main file 3-main_b.c to try a case that is a leap year: 02/29/2000.
